            ...
            <div class="mt-6 rounded-xl border border-brand-200 bg-gradient-to-br from-brand-50 to-white p-4 shadow-sm"
                ...
                <div class="mt-3 flex flex-wrap gap-2">
                    ...
                    <a href="https://wa.me/?text={{ $waText }}" target="_blank" rel="noopener"
                       class="inline-flex items-center gap-1.5 rounded-lg px-3 py-2 text-xs font-semibold text-white shadow-sm transition hover:opacity-90"
                    ...
                    <a href="https://twitter.com/intent/tweet?url={{ $encodedUrl }}&text={{ $twText }}" target="_blank" rel="noopener"
                       class="inline-flex items-center gap-1.5 rounded-lg px-3 py-2 text-xs font-semibold text-white shadow-sm transition hover:opacity-80"
