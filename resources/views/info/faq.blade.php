...
<section class="mx-auto max-w-3xl px-4 py-12" x-data="{ open: null }">
    ...
    <div class="mt-4 space-y-3">
        @foreach([
            ...
            ['Apa bedanya dengan Google Play Books / Gramedia Digital?', 'Terbuka untuk penulis indie tanpa kontrak penerbit, watermark personal (bukan DRM yang ribet), komisi adil untuk penulis lokal, dan tidak perlu akun luar negeri khusus — cukup kartu debit Visa/Mastercard yang sudah dimiliki kebanyakan orang.'],
            ['Cara bayarnya gimana?', 'Klik Beli Sekarang → kamu akan diarahkan ke halaman checkout dengan tombol <strong>PayPal</strong>. Pembayaran dilakukan via PayPal menggunakan <strong>kartu debit Visa/Mastercard</strong> (Bank Jago, Jenius, BNI, Mandiri, dll) atau <strong>kartu kredit</strong> (Visa/Mastercard/Amex). Harga tampil dalam Rupiah, dikonversi ke USD otomatis saat checkout. Setelah bayar sukses, langsung redirect ke Perpustakaan Saya.<br><br><span class="text-slate-500 text-xs">⏳ Metode pembayaran lokal (QRIS, Transfer Bank, GoPay, OVO, dll) sedang dalam proses aktivasi dan akan segera tersedia.</span>'],
            ['Saya gak punya kartu debit/kredit Visa atau Mastercard, bisa beli?', 'Saat ini pembayaran hanya via <strong>PayPal</strong> dengan kartu <strong>Visa atau Mastercard</strong> (debit/kredit). Jika kamu belum punya kartu tersebut, beberapa opsi cepat:<br><ul class="mt-1 space-y-0.5"><li>• Buka rekening <strong>Bank Jago</strong> atau <strong>Jenius</strong> (proses online, kartu Visa debit aktif dalam beberapa hari)</li><li>• Gunakan kartu debit BNI/Mandiri/BCA/BRI tipe Visa atau Mastercard (bukan GPN)</li></ul><br><span class="text-slate-500 text-xs">⏳ QRIS, Transfer Bank, dan e-wallet (GoPay/OVO/Dana) akan segera tersedia.</span>'],
            ...
            ['Kartu debit apa saja yang bisa dipakai di PayPal?', '<p class="mb-2">Kartu debit <strong>harus berlogo Visa atau Mastercard</strong> (bukan GPN-only). Berikut yang bisa dipakai:</p><p class="font-semibold mb-1">🏦 Bank Digital (paling mudah):</p><ul class="mb-2 space-y-0.5"><li>✓ Bank Jago (Visa)</li><li>✓ Jenius BTPN (Visa)</li><li>✓ SeaBank (Visa)</li><li>✓ Line Bank (Visa)</li><li>✓ Bank Neo/NEO+ (Visa)</li><li>✓ Blu by BCA Digital (Mastercard)</li><li>✓ Superbank (Mastercard)</li><li>✓ Motion Banking (Visa)</li></ul><p class="font-semibold mb-1">🏦 Bank Konvensional (tipe Visa/Mastercard):</p><ul class="mb-2 space-y-0.5"><li>✓ BNI Visa Debit International</li><li>✓ Mandiri Visa Debit</li><li>✓ BCA Mastercard Debit (bukan GPN)</li><li>✓ BRI Visa/Mastercard Debit</li><li>✓ CIMB Niaga Visa/Mastercard</li><li>✓ Permata Visa Debit</li><li>✓ Danamon Visa Debit</li></ul><p class="font-semibold mb-1">💳 Kartu Kredit:</p><p>Semua kartu kredit Visa, Mastercard, American Express dari bank manapun bisa dipakai langsung.</p><p class="mt-2 text-amber-700 bg-amber-50 rounded p-2 text-xs">⚠️ Kartu debit GPN-only (tidak ada logo Visa/Mastercard di kartu fisik) tidak bisa dipakai di PayPal. Cek kartu atau aplikasi bank kamu.</p>'],
